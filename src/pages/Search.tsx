        ...
        <div className="flex items-center gap-3">
          {user ? (
            ...
            <>
              <Link
                to="/login"
                className="px-4 py-2 text-sm font-body font-medium text-foreground hover:text-foreground/70 transition-colors"
              >
                Log in
              </Link>
              <Link
                to="/signup"
                className="px-4 py-2 text-sm font-body font-medium bg-primary text-primary-foreground hover:bg-primary/90 rounded-md transition-colors"
              >
                Sign up
              </Link>
            </>
